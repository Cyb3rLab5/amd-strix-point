...
class FramePackTransformer(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def initialize_teacache(self, enable_teacache=True, num_steps=25, rel_l1_thresh=0.15):
        ...
        # ⚡ Bolt Optimization: Evaluating np.poly1d on single scalar values in PyTorch hot loops
        # introduces significant Numpy overhead. We evaluate the polynomial using a native Python
        # implementation (Horner's method, unrolled to avoid loop overhead) on the CPU.
