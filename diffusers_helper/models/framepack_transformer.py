...
class FramePackTransformer(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    ...
    def initialize_teacache(self, enable_teacache=True, num_steps=25, rel_l1_thresh=0.15):
        ...
        # ⚡ Bolt Optimization: Use a list of coefficients instead of np.poly1d
        # Evaluating np.poly1d on scalar values introduces significant Numpy overhead in a PyTorch hot loop.
    ...
    def forward(
        ...
        if self.enable_teacache:
            ...
            if self.cnt == 0 or self.cnt == self.num_steps-1:
                ...
                # ⚡ Bolt Optimization: Native Python Horner's method implementation
                # Avoids Numpy overhead for single scalar polynomial evaluation.
                rescaled_value = 0.0
                for coeff in self.teacache_rescale_coeffs:
                    rescaled_value = rescaled_value * curr_rel_l1 + coeff

                self.accumulated_rel_l1_distance += rescaled_value
